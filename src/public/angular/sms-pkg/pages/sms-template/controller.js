...
app.component('smsList', {
    templateUrl: sms_list_template_url,
        ...
        $scope.deleteConfirm = function() {
            ...
            $http.get(
                ...
                if (response.data.success) {
                    ...
                    $('#smss_list').DataTable().ajax.reload(function(json) {});
...
//------------------------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------------------------
app.component('smsForm', {
    templateUrl: sms_form_template_url,
